      ...
      >
        ...
        <div className="px-4 py-2 space-y-6 text-[#0f380f]">
          ...
          <div className="space-y-4">
            <h3 className="text-xs uppercase border-b-2 border-[#0f380f] pb-2 mb-4">Timers (MIN)</h3>
            ...
            <div className="flex items-center justify-between cursor-pointer" onClick={() => handleChange('autoStartBreaks', !localSettings.autoStartBreaks)}>
              <h3 className="text-xs uppercase">Auto Start Breaks</h3>
              <div className={`w-4 h-4 border-2 border-[#0f380f] flex items-center justify-center ${localSettings.autoStartBreaks ? 'bg-[#0f380f]' : 'bg-[#9bbc0f]'}`}>
                {localSettings.autoStartBreaks && <div className="w-2 h-2 bg-[#9bbc0f]"></div>}
              </div>
            </div>

            <div className="flex items-center justify-between cursor-pointer" onClick={() => handleChange('autoStartPomodoros', !localSettings.autoStartPomodoros)}>
              <h3 className="text-xs uppercase">Auto Start Pomo</h3>
              <div className={`w-4 h-4 border-2 border-[#0f380f] flex items-center justify-center ${localSettings.autoStartPomodoros ? 'bg-[#0f380f]' : 'bg-[#9bbc0f]'}`}>
                {localSettings.autoStartPomodoros && <div className="w-2 h-2 bg-[#9bbc0f]"></div>}
              </div>
            </div>
          </div>
        </div>
