            ...
            <div className="w-full flex justify-between mt-2 z-10">
              <div
                className={`text-[8px] text-gb-pixel ${
                  mode === 'pomodoro' ? 'bg-gb-pixel text-gb-screen px-1' : 'opacity-50'
                }`}
              >
                POMO
              </div>
              <div
                className={`text-[8px] text-gb-pixel ${
                  mode === 'shortBreak' ? 'bg-gb-pixel text-gb-screen px-1' : 'opacity-50'
                }`}
              >
                SHORT
              </div>
              <div
                className={`text-[8px] text-gb-pixel ${
                  mode === 'longBreak' ? 'bg-gb-pixel text-gb-screen px-1' : 'opacity-50'
                }`}
              >
                LONG
              </div>
